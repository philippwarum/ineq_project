...
Bilden Sie jeweils die Summe der entsprechenden Einkommen im Haushalt (für post-tax disposable income sollte dies hy020 entsprechen), dividieren dies durch den Äquivalenzfaktor (hx050) und ordnen dieses Äquivalenzeinkommen allen Personen (auch jenen unter 16 Jahren, daher SILC – Personenregister, Tabelle R) zu. 
