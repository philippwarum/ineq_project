...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Gemeinsame Einkommensverteilung der EU28 (2016), Primäreinkommen (P1)", fig.asp=0.55, fig.pos='H'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Gemeinsame Einkommensverteilung der EU28 (2016), verfügbare Einkommen (P1)", fig.asp=0.55, fig.pos='H'}
#load data
...
theil_2016.p1[which(is.na(theil_2016.p1), arr.ind = TRUE)] <- ""
theil_2010.p1[which(is.na(theil_2010.p1), arr.ind = TRUE)] <- ""
...
theil_2010.p2[which(is.na(theil_2010.p2), arr.ind = TRUE)] <- ""
theil_2016.p2[which(is.na(theil_2016.p2), arr.ind = TRUE)] <- ""
