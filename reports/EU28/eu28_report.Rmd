...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Gemeinsame Einkommensverteilung der EU28, Primäreinkommen (P1)", fig.asp=0.55, fig.pos='H'}
